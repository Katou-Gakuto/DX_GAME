...
int sample3D()
{
	...
	// エフェクトリソースを読み込む。
	// 読み込む時に大きさを指定する。
	//int effectResourceHandle = LoadEffekseerEffect("../../../Resource/Effect/TESTES.efk"/*"Laser01.efkefc"*/, 1.0f);
	int effectResourceHandle = LoadEffekseerEffect("Texture/TESTES.efk", 1.0f);
