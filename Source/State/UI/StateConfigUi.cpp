...
// 全コンフィグ描画設定
void ConfigSelectState::AllConfigDrawSetting(UIBase* ui)
{
    if (ui->GetPreSelectnumber() != ui->GetSelectNumber())
    {
